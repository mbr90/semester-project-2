...
export default function Footer() {
  return (
    <footer className="flex-col xl:flex xl:flex-row xl:justify-between bg-midnightBlue min-h-[20px] px-10 py-10 ">
      <div className="w-full max-w-[1920px] flex-col xl:flex xl:flex-row xl:justify-between mx-auto ">
        ...
        <div className="text-myWhite flex my-5 justify-center gap-1 xl:order-last xl:my-0 max-w-[350px] mx-auto">
          ...
          <p className="my-auto font-sans text-[18px]">
            contact@salechampz.com
          </p>
        </div>
