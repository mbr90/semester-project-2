export default function Button(props) {
  ...
  return (
    <div className={`relative h-fit w-fit pr-[10px] group my-auto`}>
      ...
      <div
        className={`${secColor} hidden sm:block z-20 absolute top-0 left-0 rounded-lg text-xl font-button font-semibold  h-[51px] px-[16px] group-hover:ml-[12px] group-hover:mt-[10px] drop-shadow-button`}
      >
